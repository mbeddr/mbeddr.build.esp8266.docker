 ...
 *
 *  Replacement for the original user_interface.h header in C:\Espressif\ESP8266_SDK\include that includes user_interface_missing.h
 */
...
#include "spi_flash.h"
#include "user_interface_missing.h"
